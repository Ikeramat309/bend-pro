...
const REGISTRY_SOURCE = [
  ...
  },
  {
    ...
    shortTitle: 'Matching',
    description: 'Match an existing offset from bend-center measurements.',
    category: 'Offset',
    route: CALCULATOR_ROUTE_PATHS.matchingOffset,
    guideId: 'matchingOffset',
    status: 'active',
    supportedConduitTypes: EMT_ONLY,
    tags: ['offset', 'matching', 'centers', 'bends'],
    sortOrder: 20,
    showOnBendsScreen: true,
    showOnHome: false,
  },
  {
    ...
    shortTitle: 'Parallel',
    description: 'Lay out a parallel run while preserving conduit spacing.',
    category: 'Offset',
    route: CALCULATOR_ROUTE_PATHS.parallelOffset,
    guideId: 'parallelOffset',
    status: 'active',
    supportedConduitTypes: EMT_ONLY,
    tags: ['offset', 'parallel', 'multiple'],
    sortOrder: 30,
    showOnBendsScreen: true,
    showOnHome: false,
  },
  ...
  },
  {
    ...
    description: 'Place two opposing 90s with a finished distance between them.',
    category: '90s',
    route: CALCULATOR_ROUTE_PATHS.backToBack,
    guideId: 'backToBack',
    status: 'active',
    supportedConduitTypes: EMT_ONLY,
  ...
  },
  {
    ...
    title: 'Kick 90',
    shortTitle: 'Kick 90',
    description: 'Small-angle kick beside a 90° — spacing from kick rise and angle.',
    category: '90s',
    route: CALCULATOR_ROUTE_PATHS.kick90,
    guideId: 'kick90',
    status: 'active',
    supportedConduitTypes: EMT_ONLY,
    tags: ['90', 'kick'],
  ...
  },
  {
    id: 'compound90',
    title: 'Compound 90',
    shortTitle: 'Compound 90',
    description: 'Clear a round or rectangular obstruction while turning 90°.',
    category: '90s',
    route: CALCULATOR_ROUTE_PATHS.compound90,
    guideId: 'compound90',
    status: 'active',
    supportedConduitTypes: EMT_ONLY,
    tags: ['90', 'compound', 'obstruction'],
    sortOrder: 40,
    showOnBendsScreen: true,
    showOnHome: false,
  },
  ...
  },
  {
    ...
    shortTitle: 'Multiple Bends',
    description: 'Organize and check absolute marks on one conduit stick.',
    category: 'Large / Advanced',
    route: CALCULATOR_ROUTE_PATHS.multipleBends,
    guideId: 'multipleBends',
    status: 'active',
    supportedConduitTypes: EMT_ONLY,
    tags: ['layout', 'multiple', 'advanced'],
    sortOrder: 20,
    showOnBendsScreen: true,
    showOnHome: false,
  },
